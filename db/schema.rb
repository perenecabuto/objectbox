...
ActiveRecord::Schema.define(:version => 20100802234621) do
  ...
  create_table "cooking_ingredients", :force => true do |t|
  ...
  create_table "cooking_recipes_ingredients", :id => false, :force => true do |t|
    t.integer  "cooking_ingredients_id", :null => false
    t.integer  "cooking_recipes_id",     :null => false
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  add_index "owners_possessions", ["owner_id", "owner_type", "possession_id", "possession_type"], :name => "owner_possession_uk", :unique => true
